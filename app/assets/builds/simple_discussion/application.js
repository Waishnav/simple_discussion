...
%o`, message, error2, detail);
  ...
  var report_spam_controller_default = class extends Controller {
...
`;
  ...
  var simplemde_controller_default = class extends Controller {
    static values = {
    ...
    customMarkdownParser(markdownText) {
      ...
      if (this.circuitEmbedValue) {
        ...
        parsedText = parsedText.replace(
          embedCircuitPattern,
          (match, circuitURL) => `<iframe src="${circuitURL}" width="540" height="300" frameborder="0"></iframe><br>`
        );
      }
      if (this.videoEmbedValue) {
      ...
      if (this.userTaggingValue) {
        ...
        parsedText = parsedText.replace(
          tagUserPattern,
          (match, username, profileURL) => `<a class="tag-user" target="_blank" href="${profileURL}">@${username}</a>`
        );
      }
      return parsedText;
    }
    initializeModals() {
      this.circuitModal = new Modal(document.getElementById("embedCircuitModal"));
      document.getElementById("insertCircuitEmbed").addEventListener("click", this.insertCircuitEmbed.bind(this));
      this.videoModal = new Modal(document.getElementById("embedVideoModal"));
    ...
    initializeUserTaggingDropdown() {
      ...
      this.editor.codemirror.on("change", function(cm, change) {
        ...
        const dropdownButtons2 = dropdown.querySelectorAll("button");
      ...
      dropdownButtons.forEach((button) => {
        button.addEventListener("click", (event) => {
          ...
          const start2 = line.lastIndexOf("@");
          codemirror.replaceRange("", { line: cursor.line, ch: start2 }, cursor);
  ...
  application.register("report-spam", report_spam_controller_default);
  application.register("simplemde", simplemde_controller_default);
})();
...
bootstrap/dist/js/bootstrap.esm.js:
  (*!
    ...
    *)
*/
//# sourceMappingURL=/assets/simple_discussion/application.js.map
